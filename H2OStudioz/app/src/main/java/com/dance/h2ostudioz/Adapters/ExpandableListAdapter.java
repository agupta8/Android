...
//    public static final int CHILD_DESC = 2;
//
//
...
//                    itemController.btn_expand_toggle.setImageResource(R.drawable.arw_down);
//                } else {
//                    itemController.btn_expand_toggle.setImageResource(R.drawable.arw_lt);
//                }
//                ((ListHeaderViewHolder) holder).header_title.setOnClickListener(new View.OnClickListener() {
//                    @Override
...
//                            while (data.size() > pos + 1 && (data.get(pos + 1).type == CHILD || data.get(pos + 1).type == CHILD_DESC)) {
...
//                TextView morning = (TextView) itemView.findViewById(R.id.morning);
//                TextView evening = (TextView) itemView.findViewById(R.id.evening);
//                day.setText(item.day.getDayName());
//                if (item.day.getMorning().size() > 0) {
//                    String morningTimeString = "";
//                    for (String timing : item.day.getMorning()) {
...
//                    }
//
//                    morning.setText(morningTimeString);
//                }
//                if (item.day.getEvening().size() > 0) {
//                    String eveningTimingString = "";
//                    for (String timing : item.day.getEvening()) {
//                        if (eveningTimingString.equalsIgnoreCase(""))
//                            eveningTimingString = eveningTimingString + timing;
//                        else {
//                            eveningTimingString = eveningTimingString + "," + timing;
//                        }
//                        evening.setText(eveningTimingString);
//                    }
//                }
//                break;
//            case CHILD_DESC:
...
//        }
//
//        public Item(int type, DayOfTheWeek day) {
//            this.type = type;
//            this.day = day;
//        }
//    }
...
//
//}
public abstract class ExpandableListAdapter<PVH extends ParentViewHolder, CVH extends ChildViewHolder>
     ...
     * available in {@link ExpandableListAdapter}
     */
     ...
     * <p>
     * Called when this {@link ExpandableListAdapter} is attached to a RecyclerView.
     *
     ...
     * <p>
     * Should be called from {@link Main#onSaveInstanceState(Bundle)} in
