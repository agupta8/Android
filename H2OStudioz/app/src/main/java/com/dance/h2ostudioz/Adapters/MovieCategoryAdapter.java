...
public class MovieCategoryAdapter extends ExpandableListAdapter<MovieCategoryViewHolder, MoviesViewHolder> {
    ...
    public MovieCategoryViewHolder onCreateParentViewHolder(ViewGroup parentViewGroup) {
        View movieCategoryView = mInflator.inflate(R.layout.list_group, parentViewGroup, false);
    ...
    public MoviesViewHolder onCreateChildViewHolder(ViewGroup childViewGroup) {
        View moviesView = mInflator.inflate(R.layout.list_item, childViewGroup, false);
